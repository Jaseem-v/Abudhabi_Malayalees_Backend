...
//* AWS Config */
const AWS_S3_BUCKET_NAME = process.env.AWS_S3_BUCKET_NAME || "AWS_S3_BUCKET_NAME";
...
const AWS_S3_BUCKET_REGION = process.env.AWS_S3_BUCKET_REGION || "AWS_S3_BUCKET_REGION";
const AWS_S3_CATEGORY_RESOURCES = process.env.AWS_S3_CATEGORY_RESOURCES || "/categorys";
const AWS_S3_GALLERY_RESOURCES = process.env.AWS_S3_GALLERY_RESOURCES || "/gallerys";
const AWS_S3_ADZ_RESOURCES = process.env.AWS_S3_ADZ_RESOURCES || "/advertisements";
